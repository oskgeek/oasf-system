...
$query = "UPDATE lecturer SET lecturer_name = '$name', lecturer_password = '$password', lecturer_email = '$email', lecturer_username = '$username', lecturer_phone_no = '$phoneNo' WHERE lecturer_id = '$id'";
