...
error_reporting(E_ALL ^ E_NOTICE);
	...
	$r= mysql_query("INSERT INTO timetable (lecturer, date, day , time , details)
VALUES ('$Lecturer', '$Date', '$Time','$Day' ,'$Subject')");
if ($r)
	echo "Successful !";
...
<table id="font" border="0" cellpadding="4" cellspacing="0" width="100%">
   ...
   <tr>
    ...
    <td width="65%"><span class="select">
      <select name="lecturer2" id="lecturer2">
  ...
  <tr>
    <td width="35%" align="right"><span class="select1">Subject:</span>: </td>
    <td width="65%">
