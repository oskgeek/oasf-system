...
$lecturer_phone_no = $_POST['contact'];
$lecturer_password = $_POST['password'];
$lecturer_email = $_POST['email'];
$lecturer_category = $_POST['category'];

 
$query = "INSERT INTO lecturer VALUES ('','$lecturer_username','$lecturer_name','$lecturer_phone_no','$lecturer_password','$lecturer_email','$lecturer_category')";
$result = mysql_query($query, $conn) or die("Could not execute query in registration_lecturer.php");
if($result)
{
...
<table id="font" border="0" cellpadding="4" cellspacing="0" width="100%">
    <form method="post" action="registration_lecturer.php">
