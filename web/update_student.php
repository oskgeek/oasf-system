...
<body>
 <?php
include ("dbase.php");
$idURL  = $_GET['student_id'];
$query = "SELECT * FROM student WHERE student_id = '$idURL '";
$result = mysql_query($query, $conn) or die("Could not execute query in update_student.php");
...
<ul id="MenuBar2" class="MenuBarHorizontal">
  <li><a class="MenuBarItemSubmenu" href="timetable.php"><img src="images/page3-img2.png" alt="" width="54" height="48" align="center" />Schedule</a></li>
...
<p class="registration">Edit Profile</p>
...
<form method="post" action="insert.php">
    ...
    <td width="65%"><input name="name" type="text" maxlength="50" size="50" id="FirstName" value="<?php echo $student_name; ?>" /></td>
  </tr>
  <div>
    <tr>
      <td width="35%" align="right"> *<span class="select1">Password :</span></td>
      <td width="65%"><input name="password" type="password" maxlength="30" size="50" id="txtpassword" value="<?php echo $student_password; ?>" />
        &nbsp;
        <span class="charac">(at least 6 chars long)</span><?php
  ...
  <tr>
    ...
    <td width="65%"><input name="email" type="text" maxlength="100" size="50" id="EMail" value="<?php echo $student_email; ?>"/></td>
  </tr>
  <tr valign="top">
    <td width="35%" valign="top" align="right"><span class="select1">Username:</span></td>
    <td width="65%" valign="top"><input name="username" type="text" maxlength="50" size="50" id="FirstName2" value="<?php echo $student_username; ?>" />
      <span class="idsl">(studentID/staffID)</span></td>
  </tr>
  <tr>
