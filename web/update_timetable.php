...
$query = "UPDATE timetable SET  date= '$Date', day = '$Day', time_id = '$Time',
details = '$Details',  WHERE lecturer_id = '$LecturerID'";
...
<table id="font" border="0" cellpadding="4" cellspacing="0" width="100%">
   ...
   <tr>
     <td align="right"><span class="select1">Lecturer ID:</span></td>
     <td><form id="form3" name="form3" method="post" action="">
       <label for="lecturerid"></label>
   ...
   <tr>
    ...
    <td width="65%"><select name="lecturer" id="lecturer">
      ...
      <option>NUR ZETY AQTAR BINTI AHMAD AZUAN</option>
      <option>RAHIWAN NAZAR BIN ROMLI</option>
      <option>BALSAM ABDUL JABBAR MUSTAFA</option>
      <option>QIN HONGWU</option>
      <option>LUHUR BAYUAJI</option>
      <option>FAUZIAH BINTI ZANUDDIN</option>
  ...
  <tr>
    <td align="right"><span class="select1">Details:</span></td>
